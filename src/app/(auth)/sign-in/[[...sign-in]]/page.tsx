...
const styles: Record<string, React.CSSProperties> = {
  ...
  input: { width: "100%", padding: ".7rem 1rem", border: `2px solid ${pinkLight}`, borderRadius: 12, fontSize: ".88rem", fontFamily: "'Nunito', sans-serif", color: textMain, background: white, outline: "none" },
  forgotLink: { fontSize: ".78rem", color: pink, fontWeight: 700, textDecoration: "none" },
  submitBtn: { width: "100%", padding: ".85rem", background: pink, color: white, border: "none", borderRadius: 50, fontSize: ".95rem", fontWeight: 800, cursor: "pointer", boxShadow: "0 4px 0 #d94f83", fontFamily: "'Nunito', sans-serif" },
